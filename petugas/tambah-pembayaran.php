...
<input name="id_spp" value="<?= $data['id_spp']?>" type="hidden" class="form-control" required>
    ...
    <div class="form-group mb-2">
        <label>NISN</label>
        <input readonly name="nisn" value="<?= $data['nisn']?>" type="number" disabled class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>Nama Siswa</label>
        <input name="nama" value="<?= $data['nama']?>" disabled class="form-control" required>
    </div>
    <div class="form-group mb-2">
