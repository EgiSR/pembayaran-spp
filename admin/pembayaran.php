...
<form action="" method="post">
    <input type="text" name="keyword" size="30" autofocus placeholder="cari siswa...." autocomplete="off">
...
<table class="table table-striped table-bordered">
        ...
        if (isset($_POST["cari"])) {
            ...
            $sql = "SELECT * FROM siswa, spp, kelas WHERE siswa.id_kelas = kelas.id_kelas AND siswa.id_spp = spp.id_spp AND nama LIKE '%$keyword%' ORDER BY nama DESC";
        }
